...
ifeq ($(FULL_TARGET),i386-linux)
override CLEAN_FILES+=$(wildcard $(COMPILER_UNITTARGETDIR)/*$(OEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*$(PPUEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*$(RSTEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*.lfm) $(wildcard $(COMPILER_UNITTARGETDIR)/*.res) $(wildcard $(COMPILER_UNITTARGETDIR)/*.or) $(wildcard ./designer/*$(OEXT)) $(wildcard ./designer/*$(PPUEXT)) $(wildcard ./project/*$(OEXT)) $(wildcard ./project/*$(PPUEXT)) $(wildcard ./project/structure/*$(OEXT)) $(wildcard ./project/structure/*$(PPUEXT)) $(wildcard ./settings/*$(OEXT)) $(wildcard ./settings/*$(PPUEXT)) $(wildcard ./utils/*$(OEXT)) $(wildcard ./utils/*$(PPUEXT)) $(wildcard *$(OEXT)) $(wildcard *$(PPUEXT)) $(wildcard *$(RSTEXT))
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override CLEAN_FILES+=$(wildcard $(COMPILER_UNITTARGETDIR)/*$(OEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*$(PPUEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*$(RSTEXT)) $(wildcard $(COMPILER_UNITTARGETDIR)/*.lfm) $(wildcard $(COMPILER_UNITTARGETDIR)/*.res) $(wildcard $(COMPILER_UNITTARGETDIR)/*.or) $(wildcard ./designer/*$(OEXT)) $(wildcard ./designer/*$(PPUEXT)) $(wildcard ./project/*$(OEXT)) $(wildcard ./project/*$(PPUEXT)) $(wildcard ./project/structure/*$(OEXT)) $(wildcard ./project/structure/*$(PPUEXT)) $(wildcard ./settings/*$(OEXT)) $(wildcard ./settings/*$(PPUEXT)) $(wildcard ./utils/*$(OEXT)) $(wildcard ./utils/*$(PPUEXT)) $(wildcard *$(OEXT)) $(wildcard *$(PPUEXT)) $(wildcard *$(RSTEXT))
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_UNITDIR+=designer project project/structure utils settings $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET) $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET)/$(LCL_PLATFORM) $(CORE_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(DCPCRYPT_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(LNET_PATH)/lazaruspackage/lib/$(CPU_TARGET)-$(OS_TARGET) .
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_UNITDIR+=designer project project/structure utils settings $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET) $(LAZ_PATH)/lcl/units/$(CPU_TARGET)-$(OS_TARGET)/$(LCL_PLATFORM) $(CORE_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(DCPCRYPT_PATH)/lib/$(CPU_TARGET)-$(OS_TARGET) $(LNET_PATH)/lazaruspackage/lib/$(CPU_TARGET)-$(OS_TARGET) .
endif
