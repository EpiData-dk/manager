...
uses
  ...
  design_field, design_heading, design_section, design_custombase, managerprocs, sysutils, project_settings, 
  ...
  settings_advanced_frame, settings2_interface, settings2_var
