  ...
  begin
    ...
    begin
      ...
      case i of
        ...
        8: H.Caption.Text := '========================================================';
        9: H.Caption.Text := 'NOTE 1): A section is a subdevision of a data entry form.';
        10: H.Caption.Text := 'Later restricted access (via password) can be tied to section level';
        11: H.Caption.Text := 'NOTE 2): Import/Export is NOT part of this test release.';
      end;
    end;

    TmpEpiSection := NewSection;
    TmpEpiSection.Name.Text := 'Known major bugs in EpiData Manager:';
    TmpEpiSection.Top := 280;
    TmpEpiSection.Left := 20;
    TmpEpiSection.Width := {$IFDEF WINDOWS}600{$ELSE}700{$ENDIF};
